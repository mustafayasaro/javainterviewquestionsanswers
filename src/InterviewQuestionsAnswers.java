/*
    ...
    C10: Heap hafızası bir Application in tüm parçaları tarafından kullanılır.
         Objectler Heap içinde depolanır ve herkesçe genel kullanıma müsaittir. Stack hafıza ise sadece bir yürütme dizisi tarafından kullanılır ve diğerleri tarafından asla kullanılamaz.
    ...
    C16: Default: ayni package ve class tan ulaşılabilir.
         ...
         Protected: sadece farklı pakette ama alt olmayan class tan ulaşılamaz.
         Diğer şekillerde ulaşılabilir.

        (Uyarı: Protected a dikkat edin lütfen yani ayni package
                ya da farklı package olması önemli değil sadece farklı package in
    ...
    C17: Class, datalarımızı barındıran içinde field variable’ları
            ve method’ların olduğu bizim çalışma alanımızdır.



    S18: Java da obje (Object) nedir ve nasıl oluşturulur?
    C18: Obje, örnek değişkenlere sahip sınıfın bir örneğidir.
         Java'da new anahtar sözcüğü kullanılarak bir Obje oluşturulur.



    S19: OOP nesne yönelimli programlama nedir?
    C19: Bu bir programlama modeli veya yaklaşımı,
         büyük ve karmaşık kodlu programlar için idealdir ve aktif olarak
         güncellenmesi ve sürdürülmesi gerekir.
    ...
    C21:Inheritance kalıtım-miras: Bir sınıfın başka bir sınıfın özelliklerini
        elde ettiği miras aldığı bir süreçtir.
    ...
    C22: Local variables: tipik olarak bir method, constructor veya block içinde kullanılır
         ve yalnızca yerel kapsamı vardır. Instance variables: objesinin kendisine bağlı bir değişkendir. Bir class içinde ancak method dışında bildirilirler.

    S23: Java da Constructors ve Methods arasındaki farklar nelerdir?
    C23: 1. Constructors: Bir objenin durumunu başlatmak için kullanılır.
    ...
    C25: Final keywordunu bir variable ile kullandığımızda onun value
         yani değeri bir kez atandığı için değiştirilemez.
    ...
    C30: 1. Static method: Static anahtar sözcüğü method adından önce kullanılmalıdır.
    ...
    C36: 1. Array, farklı veri türlerinin değerlerini içeremez.
